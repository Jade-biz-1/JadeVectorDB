  ...
  const tutorialSteps = [
    {
      ...
      `,
      codeExample: `
        // Example of CRUD operations in JadeVectorDB
        ...
        const createResult = await client.storeVector(db.id, newVector);
        console.log("Vector created:", createResult.id);
...
export default VectorManipulation;