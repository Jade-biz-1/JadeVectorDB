...
const AdvancedSearchTutorial = () => {
  ...
  const completeModule = () => {
    ...
    // Unlock next module
    actions.unlockModule(3);
    // Add achievement
    actions.addAchievementIfNotExists({
      id: "advanced_search_master",
      title: "Advanced Search Master",
      description: "Completed the Advanced Search tutorial module",
      icon: "🔍",
...
export default AdvancedSearchTutorial;