...
enum class ErrorCode {
    ...
    INDEX_NOT_READY = 103,
    SIMILARITY_SEARCH_FAILED = 104,
    EMBEDDING_GENERATION_FAILED = 105,
    STORAGE_IO_ERROR = 106,
    NETWORK_ERROR = 107,
    SERIALIZATION_ERROR = 108,
    DESERIALIZATION_ERROR = 109,
    MEMORY_MAPPING_ERROR = 110,
    INDEX_BUILDING_ERROR = 111,
    QUERY_EXECUTION_ERROR = 112,
    BATCH_PROCESSING_ERROR = 113,
    METADATA_VALIDATION_ERROR = 114,
    CONFIGURATION_ERROR = 115,
    AUTHENTICATION_ERROR = 116,
    AUTHORIZATION_ERROR = 117,
    RATE_LIMIT_EXCEEDED = 118,
    QUOTA_EXCEEDED = 119
};
